package com.pyzpre.create_bic_bit.compat.jei;

import com.mojang.blaze3d.vertex.PoseStack;
import com.pyzpre.create_bic_bit.block.mechanicalfryer.DeepFryingRecipe;
import com.pyzpre.create_bic_bit.compat.jei.animations.AnimatedFryer;
...
public class FryingCategory extends CreateRecipeCategory<DeepFryingRecipe> {
    ...
    @Override
    public void draw(DeepFryingRecipe recipe, IRecipeSlotsView iRecipeSlotsView, PoseStack matrixStack , double mouseX, double mouseY) {
        ...
        Minecraft.getInstance().font.draw(matrixStack, Lang.translateDirect(requiredHeat.getTranslationKey()), 9, 86, requiredHeat.getColor());
