...
import com.pyzpre.create_bic_bit.item.*;
import com.pyzpre.create_bic_bit.item.wrapped.WrappedItem;
import com.pyzpre.create_bic_bit.item.wrapped.WrappedKetchupItem;
import com.pyzpre.create_bic_bit.item.wrapped.WrappedKetchupMayoItem;
import com.pyzpre.create_bic_bit.item.wrapped.WrappedMayoItem;
...
public class ItemRegistry {
    ...
    public static final ItemEntry<ForgeSpawnEggItem> HERRING_SPAWN_EGG = REGISTRATE.item("herring_spawn_egg",
            properties -> new ForgeSpawnEggItem(
