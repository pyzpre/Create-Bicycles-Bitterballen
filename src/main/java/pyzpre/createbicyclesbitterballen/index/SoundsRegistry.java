...
public class SoundsRegistry {
    ...
    private static SoundEntryBuilder create(String name) {
        return create(CreateBitterballen.asResource(name));
    }
    ...
    public static class SoundEntryBuilder {
        ...
        public SoundEntryBuilder addVariant(String name) {
            return addVariant(CreateBitterballen.asResource(name));
        }
    ...
    private static class WrappedSoundEntry extends SoundEntry {
        ...
        public SoundEvent getMainEvent() {
            // Return the first SoundEvent in the compiled list as the main event
            return compiledEvents.isEmpty() ? null : compiledEvents.get(0).event();
        }
