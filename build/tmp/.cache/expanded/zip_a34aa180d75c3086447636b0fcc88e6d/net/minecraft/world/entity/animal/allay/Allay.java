...
public class Allay extends PathfinderMob implements InventoryCarrier {
   ...
   public boolean wantsToPickUp(ItemStack p_218387_) {
      ...
      return !itemstack.isEmpty() && itemstack.sameItemStackIgnoreDurability(p_218387_) && this.inventory.canAddItem(p_218387_) && net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(this.level, this);
   }
