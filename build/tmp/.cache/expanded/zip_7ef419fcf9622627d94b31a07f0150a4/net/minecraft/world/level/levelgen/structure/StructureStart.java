...
public final class StructureStart {
   ...
   public CompoundTag createTag(StructurePieceSerializationContext p_192661_, ChunkPos p_192662_) {
      ...
      if (this.isValid()) {
         if (p_192661_.registryAccess().registryOrThrow(Registry.STRUCTURE_REGISTRY).getKey(this.getStructure()) == null) { // FORGE: This is just a more friendly error instead of the 'Null String' below
